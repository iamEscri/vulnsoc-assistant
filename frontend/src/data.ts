...
export const entrySchema=z.object({
 ...
 equipos_afectados:z.array(z.object({nombre:z.string(),ip:z.string().optional(),criticidad:z.string(),coincidencias:z.array(z.string()),coincidencias_plataforma:z.array(z.string()).default([]),estado:z.string().optional(),exposicion:z.string().optional(),limitacion:z.string().optional()})).default([])
}).passthrough();
